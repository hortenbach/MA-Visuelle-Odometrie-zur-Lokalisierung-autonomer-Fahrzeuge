...
if __name__ == "__main__":
    ...
    # get topic with list(topics.keys())[number-1]
    caminfo_l = parser.get_messages("/carla/ego_vehicle/rgb_left/camera_info")
    caminfo_r = parser.get_messages("/right/camera_info")
    ...
    for i in range(350, 355):
        ...
        cv2.imshow("Left Cam Image", cv_img_l)
        cv2.imwrite(f"pictures/image_left_{i}.jpg", cv_img_l)
        cv2.imwrite(f"pictures/image_right_{i}.jpg", cv_img_r)
