...
# -- Global functions ----------------------------------------------------------
# ==============================================================================
def ma_add_sensor_setup(world, actor):
        ...
        camera.listen(lambda sensor_data: vo_callback(sensor_data))
...
class World(object):
    ...
    def restart(self):
        ...
        # self.vo_sensor = VOSensor(self.player)
        ...
        #############
        ma_add_sensor_setup(self.world, self.player)
        # world = self.world
        # camera_bp = world.get_blueprint_library().find('sensor.camera.rgb')
        # # Modify the attributes of the blueprint to set image resolution and field of view.
        # camera_bp.set_attribute('image_size_x', '1920')
...
class VOSensor(object):
    def __init__(self, parent_actor):
        ...
        camera.listen(lambda sensor_data: VOSensor._vo_callback(sensor_data))

    
    @staticmethod
    def _vo_callback(sensor_data):
        print("hello rgb sensor")
# ==============================================================================
# -- IMUSensor -----------------------------------------------------------------
# ==============================================================================
...
def main():
    ...
    try:
        ...
        for arg in vars(args):
            logging.info(str((arg, getattr(args, arg))))
